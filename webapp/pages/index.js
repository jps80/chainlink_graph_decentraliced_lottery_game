...
export default function Home() {
  ...
  */
  ...
  const checkIfGameStarted = async () => {
    try {
      ...
      if (_gameStarted) {
        _logs = [`Game has started with ID: ${_game.id} and with entryFee of ${_game.entryFee} WEI (MATIC) `];
  ...
  */
  ...
  return (
    <div>
      <Head>
        <title>Smart Lottery Game</title>
        <meta name="description" content="LW3Punks-Dapp" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to Smart Lottery Game!</h1>
